  ...
  return (
    <section className="relative flex min-h-screen items-end overflow-hidden px-5 pb-10 pt-28 md:px-10 md:pb-16">
      <MotionFadeInImage
        ...
        alt="Model wearing premium minimalist fashion"
        loading="eager"
        decoding="async"
        fetchPriority="high"
     ...
     <div
  className="absolute inset-0 bg-linear-to-t from-black via-black/40 to-black/20"
  aria-hidden="true"
/>
      ...
      <div className="relative z-10 grid w-full gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-end">
        ...
        >
          ...
          <a
            href="#shop"
            className="inline-flex items-center gap-3 rounded-full bg-white px-6 py-3 text-sm font-medium uppercase tracking-[0.18em] text-black transition hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
          >
            Shop Collection
